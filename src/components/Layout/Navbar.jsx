      ...
      <nav className="py-8">
        <div className="container flex justify-between flex-wrap md:flex-nowrap gap-5">
          ...
          <div className="flex gap-5 md:gap-10 order-2 md:order-3">
            <Link
              to="/login"
              className="flex gap-1.5 items-center text-base font-normal text-primary"
            >
            ...
            >
              ...
              <span className="w-5 h-5 rounded-full text-white flex items-center justify-center bg-red-500 text-sm">
                1
              </span>
            </Link>
          </div>
